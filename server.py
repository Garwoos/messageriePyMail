...
class Server:
    ...
    def start_server(self):
        ...
        while True:
            ...
            client.send(
                "You are now connected to the server.".encode('utf-8'))  # Send connection confirmation to client
    ...
    def send_message_to_all_except_sender(self, sender_identifier, message):
        [client.send(f"{sender_identifier}: {message}".encode('utf-8')) for identifier, client in self.clients.items()
